...
3. Please provide a link to the repository you are using for this class.
    ...
    https://github.com/kh3382/cs283/tree/main

4. Briefly describe what you want to get out of this class.
    
    C is the programming language I am least comfortable programming in. It has also been a while since I've used Linux, so I am looking forward to programming in C and becoming more familiar with using Linux, while getting a general better understanding of computer architecture and operating systems. 

5. Briefly describe any concerns you might be having with being successful in this class (if any).

    As I've mentioned previously, I am not too proficient with programming in C, nor do I have much familiarity with using Linux. Because of this, I am worried that I may fall behind easily or won't immediately understand the examples explained in class. But I will try my best, nonetheless!